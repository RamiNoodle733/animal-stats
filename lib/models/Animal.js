...
const SubstatSchema = new mongoose.Schema({
    ...
    natural_weapons: { type: Number, default: 0, min: 0, max: 100 },
    armor: { type: Number, default: 0, min: 0, max: 100 },
    resilience: { type: Number, default: 0, min: 0, max: 100 },
    speed_stat: { type: Number, default: 0, min: 0, max: 100 },
    ...
    unique_abilities: { type: Number, default: 0, min: 0, max: 100 }
}, { _id: false });
...
const AnimalSchema = new mongoose.Schema({
    ...
    image: { 
        type: String, 
        default: 'https://via.placeholder.com/350x350?text=No+Image' 
    }
}, {
