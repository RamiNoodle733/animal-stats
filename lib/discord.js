...
function createEmbed(eventType, data) {
    ...
    switch (eventType) {
        case 'vote':
            return {
                title: '🗳️ New Vote',
                color: data.voteType === 'up' || data.voteType === '👍 Upvote' ? 0x00ff88 : 0xff3366,
                fields: [
        ...
        case 'vote_removed':
            return {
                ...
                fields: [
                    { name: 'User', value: data.user, inline: true },
                    { name: 'Animal', value: data.animal, inline: true },
                    { name: 'Removed Vote', value: data.voteType === 'up' ? '👍 Was Upvote' : '👎 Was Downvote', inline: true }
                ],
                timestamp
            };
        ...
        case 'site_visit':
            return {
                ...
                fields: [
                    ...
                    { name: 'Page', value: data.page || 'Home', inline: true }
                ],
                timestamp
            };
