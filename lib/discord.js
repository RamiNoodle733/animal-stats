...
function createEmbed(eventType, data) {
    ...
    switch (eventType) {
        ...
        case 'comment_reply':
            return {
                title: EMOJI.REPLY + ' Comment Reply',
                color: 0x00b4d8,
                fields: [
                    { name: 'User', value: data.user, inline: true },
        ...
        case 'comment_upvote':
            return {
                title: EMOJI.THUMBS_UP + ' Comment Upvoted',
                color: 0x00cc88,
                fields: [
        ...
        case 'comment_downvote':
            return {
                title: EMOJI.THUMBS_DOWN + ' Comment Downvoted',
                color: 0xcc3366,
                fields: [
                    { name: 'By', value: data.user, inline: true },
                    { name: 'Comment Author', value: data.commentAuthor, inline: true },
        ...
        case 'logout':
            return {
                title: EMOJI.LOCKED + ' User Logout',
                color: 0xff9900,
                fields: [
                    { name: 'Username', value: data.username, inline: true }
                ],
        ...
        case 'site_leave':
            return {
                title: EMOJI.WAVE + ' User Left Site',
                color: 0x666666,
                fields: [
